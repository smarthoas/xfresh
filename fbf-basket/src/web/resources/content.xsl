...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template name="main">
        <xsl:apply-templates select="/page/data/basket/content" mode="show"/>
    </xsl:template>

    <xsl:template match="/page/data/basket/content" mode="show">
            ...
            <table width="80%" align="center" class="general-table">
                <tr>
                    <td colspan="5">
                        <div>
                            <xsl:choose>
                                <xsl:when test="count(basket-market-item) &gt; 0">
                ...
                <xsl:if test="count(basket-market-item) &gt; 0">
                    ...
                    <xsl:for-each select="basket-market-item">
